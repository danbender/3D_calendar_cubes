...
var init = function() {
  initBox(document.querySelector("#cube1"));
  initBox(document.querySelector("#cube2"));
};

function initBox (el) {
  var box = el.querySelector('.container').children[0],
      showPanelButtons = el.querySelectorAll('.show-buttons button'),
